 ...
 * You can now use this utility to generate JWT tokens
 ...
 mvn exec:java -Dexec.mainClass=common.security.TokenUtil -Dexec.classpathScope=test -Dexec.args="/home/user2015/keys/jwt-private.pem admin2015 ADMIN"
...
public class TokenUtil {
    ...
    public static String generateJWT(final String privateKeyFilePath, final String principal, final String... groups) throws Exception {
        ...
        JsonObjectBuilder claimsBuilder = Json.createObjectBuilder()
                ...
                .add("iat", currentTime)
                .add("exp", currentTime + 1440000);	// Set expiry time to 4 hours (4 * 60 * 60)
